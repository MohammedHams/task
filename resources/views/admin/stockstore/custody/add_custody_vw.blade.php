  ...
  <div class="caption">
   ...
   <div class="form-body">
      ...
      <div class="col-sm-12">
          ...
          <table class="table table-striped table-bordered table-hover" id="custody_vw_data">
                <thead>
                  <tr>
                    <th> اسم  الموظف  </th>
                    <th>القسم </th>
...
<div class="row">
      <div class="col-sm-12">
         ...
         <input type="hidden" class="form-control" id="item_code_in" name="item_code_in" >

          <input type="hidden" class="form-control" id="item_id_pk_edit" name="item_id_pk_edit" >
            ...
            <div class="form-group col-sm-6 type">
             ...
             <!--   <div class="form-group col-sm-6  ">
              ...
              <div class="form-group col-sm-6  ">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control  date-picker" placeholder="تاريخ   الاستلام  " id="custody_receiving_date_in" name="custody_receiving_date_in"  data-date-format="dd/mm/yyyy" >
                    </div>
...
<!--=============================deliver date=====================================-->
 ...
 <div class="modal fade" id="delivery_data_modal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
     <div class=" modal-dialog modal-xl">
    <div class="modal-content">
     <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">
...
<div class="caption">
  <i class="fa fa-map font-red-thunderbird"></i>
    <span class="caption-subject  bold uppercase borderd font-red-thunderbird"> تعديل   تاريخ   التسليم   </span>
...
<div class="portlet-body form">
                                                <!-- BEGIN FORM-->
    <form  class="form-horizontal"  method="post"   id="delivery_data_form" enctype="multipart/form-data" >
         {{ csrf_field() }}
     <div class="alert alert-danger" id="delivery_data_alert" style="display:none" >
                        <ul id="delivery_data_error"> 
                        </ul>
                        </div>
...
<div class="row">
      ...
      <input type="hidden" id="cust_id_in" name="cust_id_in">

   
 
              <div class="form-group col-sm-6  ">
                <label class="col-md-4 control-label color-view bg-blue-dark bg-font-blue-dark"> تاريخ  التسليم    <span style="color:red;">*</span></label>
                <div class="col-md-8">
                    <input type="text" class="form-control  date-picker" placeholder="تاريخ   التسليم  " id="custody_delivery_date_in" name="custody_delivery_date_in"  data-date-format="dd/mm/yyyy" >
                    </div>
...
$("#add_custody_data_form").on('submit', function(e) {
  ...
  e.preventDefault(); 
    ...
    $.ajax({
      url:'{!! URL::asset("/stock_store/custody/add_custody_data") !!}',
...
function custody_vw_data(){
 
    $('#custody_vw_data').DataTable({
      destroy: true,
      processing: true,
      serverSide: true,
     "pageLength": 25,
   ...
   $("#loading5").hide();
      ...
      "ajax": {
            "url": '{!! URL::asset("/stock_store/custody/custody_vw_data") !!}',
            "data": function ( d ) {
      ...
      columns: [
                 ...
                 {data: 'custody_receiving_date1', name: 'custody_receiving_date1'},
    
                  {data: 'delivery_data', name: 'delivery_data'},
                   {data: 'transform_custody_data', name: 'transform_custody_data'},
...
function transform_custody_data(item_code,item_id_pk){
$("#add_custody_data_modal").modal("toggle");
$("#item_code_in").val(item_code);

//$("#item_id_pk_in").select2("val", item_id_pk);


//$("#item_id_pk_in option[value='"+item_id_pk+"']").attr('selected', 'selected');
$( "#item_id_pk_in" ).val(item_id_pk).trigger('change');

$("#item_id_pk_edit").val(item_id_pk);

}

/****************************/
function delivery_data(cust_id){

$("#delivery_data_modal").modal("toggle");
$( "#item_id_pk_in" ).val('').trigger('change');
$("#cust_id_in").val(cust_id);
...
$("#delivery_data_form").on('submit', function(e) {
  ...
  e.preventDefault(); 
    ...
    $.ajax({
      url:'{!! URL::asset("/stock_store/custody/update_custody_delivery") !!}',
      data:new FormData($("#delivery_data_form")[0]),
      dataType:'json',
      async:false,
      type:'POST',
      processData: false,
      ...
      success:function(e) {
            ...
            if (e['result'] == 'ok') {
                jSuccess(e['response'], {TimeShown: 2000, HorizontalPosition: 'left'});
                 $('#delivery_data_alert').hide();
                  $('#delivery_data_form')[0].reset();
            ...
            error: function(e) 
            {
                 $('#loading1').hide();
               $('#add').show();
              $('#delivery_data_alert').show();
              $('#delivery_data_error').empty();
              var error = e.responseJSON;
              $.each(error, function (i, member) {
              for (var i in member) {
              $('#delivery_data_error').append('<li >'+ member[i] +'</li>' );
             }
           });
