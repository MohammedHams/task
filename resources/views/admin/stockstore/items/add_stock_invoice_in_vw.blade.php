...
<div class="caption">
    ...
    <span class="caption-subject font-dark bold uppercase font-red-flamingo"> طلبيات  ادخال    </span>
 ...
 <div class="actions">
  ...
  <a href="#" class="btn btn-circle red-thunderbird btn-outline btn-sm" onclick="add_stock_invoice_in_data()"><i class="fa fa-plus"></i>  اضافة  طلبية  ادخال      </a>
...
<div class="row">
  ...
  <select id="side_id_in"  name="side_id_in" class="form-control select2 " >
            ...
            <div class="form-group col-sm-6 note1_in">
                <label class="col-md-4 control-label color-view bg-blue-dark bg-font-blue-dark">سعر الصرف بالدولار <span style="color:red;">*</span>  </label>
                <div class="col-md-8">
            ...
            <div class="form-group col-sm-6 note1_in">
                <label class="col-md-4 control-label color-view bg-blue-dark bg-font-blue-dark">سعر الصرف بالدينار <span style="color:red;">*</span>  </label>
                <div class="col-md-8">
...
<div class="modal fade in" id="stock_beginning_item_vw_modal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
     <div class=" modal-dialog modal-xl">
    <div class="modal-content">
     <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">
...
<div class="caption">
    <i class="icon-share font-red-thunderbird"></i>
    <span class="caption-subject font-red-thunderbird bold uppercase"> عناصر طلبية الجرد   </span>
    <br>
 <i class="fa fa-info font-red-thunderbird"></i>
      <span class="caption-subject font-red-thunderbird bold uppercase" id="stock_beginning_item_vw_one_data"></span>
</div>
...
<div class="portlet-body form">
 ...
 <form  class="form-horizontal"  method="post"   id="add_begining_inv_item" enctype="multipart/form-data" >
         {{ csrf_field() }}
     <div class="alert alert-danger" id="add_begining_inv_item_alert" style="display:none" >
                        <ul id="add_begining_inv_item_error"> 
                        </ul>
                        </div>
...
<div class="row">
      <div class="col-sm-12">
           ...
           <div class="form-group col-sm-6  ">
                <label class="col-md-4 control-label color-view bg-blue-dark bg-font-blue-dark"> عناصر الطلبية  <span style="color:red;">*</span></label>
                <div class="col-md-8">
                  <div id="the-basics">

                    <input type="hidden" name="beg_id_in" id="beg_id_in">
                    <input type="hidden" name="beg_inv_id_pk_in" id="beg_inv_id_pk_in">
                    


  <select id="beg_item_id_pk_in"  name="beg_item_id_pk_in" class="form-control select2 " >
                      <option value=""> اختر  الصنف   </option>
                ...
                <div class="form-group col-sm-6 ">
                <label class="col-md-4 control-label color-view bg-blue-dark bg-font-blue-dark"> العدد قبل الجرد  </label>
                <div class="col-md-8">
                    <input type="text" class="form-control " placeholder="العدد قبل الجرد   " id="beg_count1_in" name="beg_count1_in"  readonly="readonly">
                ...
                <div class="form-group col-sm-6 ">
                <label class="col-md-4 control-label color-view bg-blue-dark bg-font-blue-dark"> العدد بعد الجرد  </label>
                <div class="col-md-8">
                    <input type="text" class="form-control " placeholder="العدد بعد الجرد   " id="beg_count2_in" name="beg_count2_in" >
              ...
              <div class="form-group col-sm-6 ">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control"  placeholder="ملاحظات   " 
                    id="beg_note_in" name="beg_note_in"  >
...
<form class="form-horizontal" role="form" method="post" 
    data-toggle="validator"   id="search1">
       ...
       <div class="form-body">
        <div  class="row">
           ...
           <div class="form-group col-sm-4 ">
                <label class="col-md-4 control-label color-view bg-blue-dark bg-font-blue-dark"> الصنف الاساسى  </label>
                <div class="col-md-8">
                


  <select id="item_id_pk_ser1"  name="item_id_pk_ser1" class="form-control select2 " >
              ...
              <input type="hidden" id="inv_id_pk_ser1" name="inv_id_pk1">
...
<!--========================================================-->
    ...
    <!--==========================================================-->  
       <div class="table-scrollable">
          ...
          <table class="table table-striped table-bordered table-hover" id="stock_beginning_item_vw">
        <thead>
               <tr>
               <th>رقم  الصنف  </th>
               <th>اسم   الصنف   </th>
                <th> العدد قبل الجرد  </th>
                <th>العدد بعد الجرد  </th>
                <th>تعديل  </th>
...
function approve_stock_invoice(inv_id_pk,inv_type){
 ...
 if(confirm("هل  انت   متاكد   من   اعتماد   الطلبية  ?"))
   ...
   var url2='{!! URL::asset("/stock_store/items/approve_stock_invoice/'+inv_id_pk+'/'+inv_type+'") !!}'; 
   $.get(url2,{ }, function (ec) {
...
/*****************لاصناف الجرد***** */
function stock_beginning_item_vw(inv_id_pk){
$("#stock_beginning_item_vw_modal").modal('toggle');

$('#add_begining_inv_item')[0].reset();
$("#beg_item_id_pk_in").val('').trigger('change');
$("#add_begining_inv_item").find('input[type=text], input[type=hidden], input[type=password], input[type=file], select, textarea').val('');
$("#add_begining_inv_item").find('input[type=radio], input[type=checkbox]').removeAttr('checked').removeAttr('selected');
$("#beg_id_in").val('');
              $("#beg_inv_id_pk_in").val('');
     

stock_beginning_item_vw_for_one_req(inv_id_pk);
$("#inv_id_pk_ser1").val(inv_id_pk);
...
$("#search1").on('submit', function(e) {
       ...
       stock_beginning_item_vw_for_one_req($("#inv_id_pk_ser1").val());
});


function stock_beginning_item_vw_for_one_req(inv_id_pk){
 
 $('#stock_beginning_item_vw').DataTable({
   destroy: true,
   processing: true,
   serverSide: true,
  "pageLength": 25,
...
$("#loading5").hide();
   ...
   "ajax": {
         "url": '{!! URL::asset("/stock_store/stock_beginning_item_vw_for_one_req/'+inv_id_pk+'") !!}',
         "data": function ( d ) {

          d.item_id_pk_ser1=$("#item_id_pk_ser1").val();
   ...
   columns: [
             {data: 'item_id_pk', name: 'item_id_pk'},
             {data: 'item_name', name: 'item_name'},
             {data: 'count1', name: 'count1'},
             {data: 'count2', name: 'count2'},
             {data: 'add_begining_inv_item', name: 'add_begining_inv_item'},
...
/**************************************** */
function add_begining_inv_item(beg_id,inv_id_pk){

  var url2='{!! URL::asset("/stock_store/stock_beginning_item_vw_only_one_data/'+beg_id+'") !!}'; 
   $.get(url2,{ }, function (ec) {

    $("#beg_item_id_pk_in").val(ec[0]['item_id_pk']).trigger('change');
    $("#beg_count1_in").val(ec[0]['count1']);
    $("#beg_count2_in").val(ec[0]['count2']);
    $("#beg_note_in").val(ec[0]['note']);
    $("#beg_inv_id_pk_in").val(inv_id_pk);
    $("#beg_id_in").val(beg_id);
...
$("#add_begining_inv_item").on('submit', function(e) {
...
e.preventDefault(); 
 ...
 $.ajax({
   url:'{!! URL::asset("/stock_store/add_begining_inv_item") !!}',
   data:new FormData($("#add_begining_inv_item")[0]),
   dataType:'json',
   async:false,
   type:'POST',
   processData: false,
   ...
   success:function(e) {
         ...
         if (e['result'] == 'ok') {
             jSuccess(e['response'], {TimeShown: 2000, HorizontalPosition: 'left'});
              $('#add_begining_inv_item_alert').hide();
              $('#add_begining_inv_item')[0].reset();
              $("#beg_item_id_pk_in").val('').trigger('change');
              $("#add_begining_inv_item").find('input[type=text], input[type=hidden], input[type=password], input[type=file], select, textarea').val('');
              $("#add_begining_inv_item").find('input[type=radio], input[type=checkbox]').removeAttr('checked').removeAttr('selected');
         ...
         error: function(e) 
         {
             // $('#loading1').hide();
           // $('#add').show();
           $('#add_begining_inv_item_alert').show();
           $('#add_begining_inv_item_error').empty();
           var error = e.responseJSON;
           $.each(error, function (i, member) {
           for (var i in member) {
           $('#add_begining_inv_item_error').append('<li >'+ member[i] +'</li>' );
          }
        });
