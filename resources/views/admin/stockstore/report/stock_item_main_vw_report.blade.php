...
<html lang="ar" class="no-js">
    <head>
        <title> الاصناف  المتوفرة  فى المخزن   </title>
                                ...
                                <div class="req_data_list textbold" style="width: 100%;">
                                    <table class="tabpos">
                                        ...
                                        <tbody>
                                        	...
                                        	@foreach($stock_item_main_vw_datas  as  $stock_item_main_vw_data)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>{{$stock_item_main_vw_data->item_id_pk }}</td>
                                                <td>  {{$stock_item_main_vw_data->item_name }} </td>
                                                <td>  {{$stock_item_main_vw_data->item_count }} </td>
