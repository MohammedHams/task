  ...
  <div class="form-group">
                <div class="col-md-offset-4 col-md-4">
                    <button type="submit" class="btn green btn-block">تعديل</button>
                      ...
                      <button type="button" class="btn green btn-block"  onclick="print()">طباعة  </button>
...
@endif
 ...
 <!--===========================user have =====================-->
    ...
    <div class="modal fade" id="user_can_access" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-xl">
 ...
 <!--===========================================================--> 
     ...
     <div class="modal fade" id="user_have_subpermission_data_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-xl">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table-striped table-bordered table-hover" id="sample_4">
                ...
                <tbody id="user_have_subpermission_data_tabel">
...
/**********************************************/
function user_have_subpermission_data(prog_num,subpermissionnumber) {
 // alert("hi");
 // exit;
  // $('#myModal').modal('toggle');
  $('#user_have_subpermission_data_modal').modal('toggle');

 user_have_subpermission_data_2(prog_num,subpermissionnumber);
}
...
function user_have_subpermission_data_2(prog_num,subpermissionnumber) {

  var add_url3='{!! URL::asset("/user_have_subpermission/'+prog_num +'/'+subpermissionnumber+'") !!}';

    $.get(add_url3, function (e) {  
 
$("#user_have_subpermission_data_tabel").empty();
  $.each(e, function(k, v) {


   $("#user_have_subpermission_data_tabel").append(' <tr > <td><a href="{!! URL::asset("user_view/'+v['id'] +'") !!}" target="_blank">'+v['full_name']+'</a></td></tr>');
 });
...
var url1='{!! URL::asset("print_permission/'+id+'") !!}';
