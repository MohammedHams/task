...
<html lang="ar" class="no-js">
    <head>
        <title>الصلاحيات  </title>
		 ...
		 <link href="{{url('/')}}/admin/assets/global/plugins/bootstrap/css/bootstrap-rtl.min.css" rel="stylesheet">
        ...
        <div class="divFooter">
            <table>
                ...
                <tbody>
                        ...
                        <td colspan="3" class="porde">
                            <div class="req_data">
                                ...
                                <div class="list_req_data">
                                    ...
                                    <div class="req_data_list dot w71" style="font-size:16px;width: 100%; text-align:center">
                                        <strong> اسم   الصلاحية   : </strong><span> {{$menu->title}}  </span>
                                    </div>
                                    <div class="req_data_list dot w28">
                                        <strong> </strong><span>                                           
					...
					<?php
                    function printMenuPer($menu){
					?>
                    	<?php if(count($menu->users)>0) {?>
                        <div class="col-xs-12 ">
                    
                            <ol class="first" style="font-size:14px;font-weight:bold;text-align:right">
                                <li> <?php echo $menu->title?> </li>
                                                                   
                                              
                                <ul class="second " style="list-style-type:square;font-size:12px">
									<?php foreach($menu->users as $user){?>
                                        <li> <?php echo  $user;?> </li>
                                    <?php }?>
					...
					printMenuPer($menu);
					/*if(count($menu->submenu)>0) {
						foreach($menu->submenu as $mn) printMenuPer($mn);
                    }*/
					?>
