<?php
Route::get('/menus/print_permission/{id}','MenuController@print_permission')->middleware('user:menu.menu_list');
...
Route::get('/user_have_subpermission/{prog_num}/{subpermissionnumber}','MenuController@user_have_subpermission')
->middleware('user:menu.menu_list'); ///نشوف الصلاحيه
