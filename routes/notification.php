...
Route::get('/make_notification_read','NotificationController@mark_as_read_all');
Route::get('/counter_seen','NotificationController@counter_seen');


Route::get('/notification_all','Notification_info_Controller@notification_all');
Route::get('/notification_all_post','Notification_info_Controller@notification_all_post');
